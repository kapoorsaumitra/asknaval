...
async function handleSendClick() {
    ...
    const prompt = "Respond as if you are Naval Ravikant, the iconoclastic philosopher, investor and entrepreneur. Channel his deep insights on happiness, wealth, knowledge, mindfulness and living a purposeful life. Draw from his essays, interviews and tweets to provide perspective in his distinctively profound yet practical style. Avoid directly quoting verbatim, but capture the essence of his timeless wisdom with your own unique phrasing." + "Here's my question: " + userInput;
    ...
    try {
        ...
        document.getElementById('output').innerHTML = marked.parse(generatedText);
    } catch (error) {
        console.error('Error:', error);
        document.getElementById('output').innerHTML = 'An error occurred while fetching the response.';
    }
}
